  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border/60 bg-background/80 backdrop-blur-xl">
      ...
      <aside
        ...
        role="dialog"
        aria-modal="true"
        className={`fixed inset-y-0 right-0 z-50 flex w-72 flex-col border-l border-border bg-background shadow-2xl motion-safe:transition-transform motion-safe:duration-300 ${
        ...
        <div className="flex flex-col gap-1 p-6 pt-20">
          {links.map((l) => (
            <a
              ...
              href={l.href}
              onClick={close}
              className="inline-flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-muted-foreground transition-colors hover:bg-secondary hover:text-foreground"
            >
              <l.Icon className="h-4 w-4" />
              {l.label}
            </a>
          ...
          <a
            ...
            rel="noreferrer"
            onClick={close}
            className="mt-2 inline-flex items-center justify-center rounded-lg border border-border px-4 py-2.5 font-mono text-xs text-muted-foreground transition-colors hover:border-primary/40 hover:text-foreground"
          >
            npm i nextjs-proxy
          </a>
        </div>
